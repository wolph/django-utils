...
class __about__:  # noqa: N801 - minimal shim, conf.py is rewritten in Task 17
...
copyright = (
    f'{datetime.date.today().year},  <a href="http://wol.ph/">'
...
latex_documents = [
    (
        ...
        f"{__about__.__package_name__.replace('-', ' ').capitalize()} Documentation",
